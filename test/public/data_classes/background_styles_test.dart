...
void main() {
  final allParamsMap = const BackgroundStyles(
    ...
    group('merge():', () {
      group('backgroundColor:', () {
        ...
        test('With theme, uses colorScheme.background', () {
          ...
          expect(newStyles.backgroundColor, colorScheme.background);
        });
        ...
        test('With otherStyles, uses otherStyles.backgroundColor', () {
          ...
          const otherStyles =
              BackgroundStyles.only(backgroundColor: Colors.amber);
          final newStyles = BackgroundStyles.merge(
              otherStyles: otherStyles, theme: themeData);
      ...
      group('borderColor:', () {
        ...
        test('With theme, uses colorScheme.onBackground', () {
          ...
          expect(newStyles.borderColor, colorScheme.onBackground);
        });
        ...
        test('With theme, uses inputDecorationTheme.outlineBorder.color', () {
          ...
          expect(
              newStyles.borderColor, inputDecorationTheme.outlineBorder!.color);
        });
      ...
      group('borderWidth:', () {
        ...
        test('With theme, uses inputDecorationTheme.outlineBorder.width', () {
          ...
          expect(
              newStyles.borderWidth, inputDecorationTheme.outlineBorder!.width);
        });
