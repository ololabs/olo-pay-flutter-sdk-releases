...
void main() {
  group('CreationParams:', () {
    const hints = Hints.singleLineDefaults;
    ...
    group('toMap():', () {
      group('All Params', () {
        ...
        test('Has correct keys', () {
          ...
          expect(allParamsMap.containsKey('enabled'), true);
        });
        ...
        test('Keys have correct values', () {
          ...
          expect(
            allParamsMap['customErrorMessages'],
            customErrorMessages.toMap(),
          );
          expect(allParamsMap['textAlignment'], textAlignment.toString());
          expect(allParamsMap['enabled'], false);
        });
      });
      ...
      group('Required Params Only', () {
        ...
        test('Has correct keys', () {
          ...
          expect(requiredParamsMap.containsKey('enabled'), true);
        });
        ...
        test('Keys have correct values', () {
          ...
          expect(
            requiredParamsMap['backgroundStyles'],
          ...
          expect(requiredParamsMap['enabled'], true);
        });
      });
    });
  });
