...
class PaymentCardDetailsFormFactory (private val messenger: BinaryMessenger) : PlatformViewFactory(
    StandardMessageCodec.INSTANCE
) {
    override fun create(context: Context, viewId: Int, args: Any?): PlatformView {
        if (context.getActivity() as? FlutterFragmentActivity == null) {
            val message = "CardDetailsForm must be used within a FlutterFragmentActivity: https://tinyurl.com/yfwr5raa"
            OloPayLog.e(message)
        ...
        return PaymentCardDetailsForm(context, messenger, viewId, creationParams)
    }
}