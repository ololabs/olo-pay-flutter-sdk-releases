...
final class CustomErrorMessagesTests: XCTestCase {
    ...
    func testGetDefaultErrorMessage_forCvvState_errorFieldState_returnsDefaultErrorMessage() {
        let emptyMessage = CustomErrorMessages.getDefaultErrorMessage(forCvvState: emptyFieldState)
        
        let invalidMessage = CustomErrorMessages.getDefaultErrorMessage(forCvvState: invalidFieldState)
        
        XCTAssertEqual(OPStrings.emptyCvvError, emptyMessage)
        XCTAssertEqual(OPStrings.incompleteCvvError, invalidMessage)
    }
    
    func testGetDefaultErrorMessage_forCvvState_validFieldState_returnsEmptyString() {
        XCTAssertEqual("", CustomErrorMessages.getDefaultErrorMessage(forCvvState: validFieldState))
    }
