    ...
    return SettingsSection(
      ...
      children: [
        SwitchListTile(
          ...
          onChanged:
              (bool value) => settingsModel.toggleOnValidStateChangedEnabled(),
        ),
        if (settingsModel.showSingleLineCardDetailsView) ...[
          SwitchListTile(
            ...
            onChanged:
                (bool value) => settingsModel.toggleOnInputChangedEnabled(),
          ),
          SwitchListTile(
            title: const Text("onFocusChanged Event"),
            value: settingsModel.onFocusChangedEnabled,
            onChanged:
                (bool value) => settingsModel.toggleOnFocusChangedEnabled(),
          ),
          SwitchListTile(
