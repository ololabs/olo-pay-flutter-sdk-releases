...
class PaymentCardDetailsSingleLineView: NSObject, FlutterPlatformView, OPPaymentCardDetailsViewDelegate {
    ...
    private func onMethodCall(call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case DataKeys.SetEnabledMethodKey:
    ...
    private func setEnabled(call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        do {
            _cardInputView.isEnabled = try args.getOrErrorResult(
                for: DataKeys.EnabledParameterKey,
                baseError: "Unable to set enabled state",
                result: result
            )
    ...
    private func requestFocus(result: @escaping FlutterResult) {
        _cardInputView.becomeFirstResponder()
        result(nil)
    }
