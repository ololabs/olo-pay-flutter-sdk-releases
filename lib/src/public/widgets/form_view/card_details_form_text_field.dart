...
///
/// To display this widget, the Android app's main activity must inherit
/// from `FlutterFragmentActivity`. For details about this restriction, refer
/// to the [Android-Specific Setup Steps](https://pub.dev/documentation/olo_pay_sdk/latest/index.html#android-specific-setup-steps)
/// in the main ReadMe.
///
...
class CardDetailsFormTextField extends StatefulWidget {
  ...
  /// @nodoc
  static BoxConstraints defaultConstraints =
      Platform.isAndroid
...
class _CardDetailsFormTextFieldState extends State<CardDetailsFormTextField> {
  ...
  void didUpdateWidget(covariant CardDetailsFormTextField oldWidget) {
    ...
    BackgroundStyles? themeAwareBackground = widget.backgroundStyles;
    themeAwareBackground ??=
        (newThemeData.brightness == Brightness.dark)
            ? BackgroundStyles.darkFormDefaults
            : BackgroundStyles.lightFormDefaults;
