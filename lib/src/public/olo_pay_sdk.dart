...
class OloPaySdk {
  ...
  /// Google Pay.
  ///
  /// An additional requirement for Google Pay is that the Android app's
  /// main activity must inherit from `[`FlutterFragmentActivity`]`. For details
  /// about this restriction, refer to the
