...
class PaymentMethod {
  ...
  ///
  /// Will only be provided for digital wallet payment methods (see [isDigitalWallet]) with [ApplePayConfiguration.fullPhoneticNameRequired] set to true.
  /// _**(iOS Only)**_
  ...
  factory PaymentMethod.fromMap(Map<dynamic, dynamic> map) {
    return PaymentMethod(
      ...
      fullPhoneticName: map[DataKeys.pmFullPhoneticNameKey] ?? "",
