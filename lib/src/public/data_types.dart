...
typedef CardDetailsSingleLineTextFieldControllerCreated =
    void Function(CardDetailsSingleLineTextFieldController controller);

/// Callback signature for when a [CardDetailsSingleLineTextField]'s state changes due to user-entered input
typedef CardDetailsInputChanged =
    void Function(bool isValid, Map<CardField, CardFieldState> fieldStates);

/// Callback signature for when a [CardDetailsSingleLineTextField]'s valid state changes
typedef CardDetailsValidStateChanged =
    void Function(bool isValid, Map<CardField, CardFieldState> fieldStates);
...
/// user
typedef CardDetailsFocusChanged =
    void Function(
...
typedef CardDetailsFormTextFieldControllerCreated =
    void Function(CardDetailsFormTextFieldController controller);
...
typedef CvvTextFieldControllerCreated =
    void Function(CvvTextFieldController controller);
